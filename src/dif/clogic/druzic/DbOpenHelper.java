...
public class DbOpenHelper {
    ...
    public long insertColumn(String name, String melodysequence){
        ContentValues values = new ContentValues();
        values.put(SongDatum.CreateDB.NAME, name);
        values.put(SongDatum.CreateDB.MELODYSEQUENCE, melodysequence);
        return mDB.insert(SongDatum.CreateDB._TABLENAME, null, values);
    }

    // Update DB
    public boolean updateColumn(long id , String name, String melodysequence){
        ContentValues values = new ContentValues();
        values.put(SongDatum.CreateDB.NAME, name);
        values.put(SongDatum.CreateDB.MELODYSEQUENCE, melodysequence);
